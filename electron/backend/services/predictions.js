...
// Recurring-series detection for the Recurring report, plus the ISO-date and
// cycle helpers it and the Recurring handler share. Pure functions over
// already-loaded rows; DB access stays in the handler.
